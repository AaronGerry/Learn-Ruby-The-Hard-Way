...
def aaron_goes_shopping(money_in_bank, needs, energy_level)
...
aaron_goes_shopping(2000, "pantalones, " + "socks, " + "sneakers", 2)
...
aaron_goes_shopping(2000 - pants_cost, need1, energy_for_pantalones)
